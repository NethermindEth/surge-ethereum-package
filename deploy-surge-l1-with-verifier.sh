...
kurtosis service update surge-devnet deploy-surge-l1 \
    --env "RISC0_BLOCK_PROVING_IMAGE_ID=${RISC0_PARAMS_BLOCK_PROVING_IMAGE_ID},RISC0_AGGREGATION_IMAGE_ID=${RISC0_PARAMS_AGGREGATION_IMAGE_ID},SP1_BLOCK_PROVING_PROGRAM_VKEY=${SP1_PARAMS_BLOCK_PROVING_PROGRAM_VKEY},SP1_AGGREGATION_PROGRAM_VKEY=${SP1_PARAMS_AGGREGATION_PROGRAM_VKEY},MR_ENCLAVE=${SGX_PARAMS_MR_ENCLAVE},MR_SIGNER=${SGX_PARAMS_MR_SIGNER},V3_QUOTE_BYTES=${SGX_PARAMS_V3_QUOTE_BYTES}"
